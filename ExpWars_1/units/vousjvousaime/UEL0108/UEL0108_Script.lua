...
UEL0108 = Class(TLandUnit) {
    ...
    Weapons = {
        MainGun = Class(TDFGaussCannonWeapon) {
			SetOnTransport = function(self, transportstate)    --AJOUT par Manimal au cas où
				self.unit:SetScriptBit('RULEUTC_WeaponToggle', false)    --AJOUT par Manimal au cas où
			end,    --AJOUT par Manimal au cas où
		},
