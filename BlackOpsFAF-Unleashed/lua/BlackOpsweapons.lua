...
RailGunWeapon01 = Class(DefaultProjectileWeapon) {
    FxChargeMuzzleFlash = {
		'/mods/BlackOpsFAF-Unleashed/effects/emitters/x_cannon_charge_test_01_emit.bp',--#lightning
    },
    FxMuzzleFlash = {
		'/mods/BlackOpsFAF-Unleashed/effects/emitters/xcannon_cannon_muzzle_01_emit.bp',--#large redish flash
		'/mods/BlackOpsFAF-Unleashed/effects/emitters/x_cannon_fire_test_01_emit.bp',--barrel lightning effect
		'/mods/BlackOpsFAF-Unleashed/effects/emitters/jugg_rail_cannon_muzzle_07_emit.bp',-- small redish flash, double quick
		'/mods/BlackOpsFAF-Unleashed/effects/emitters/jugg_rail_cannon_muzzle_08_emit.bp',-- small redish double flash
	},
...
XCannonWeapon01 = Class(DefaultProjectileWeapon) {
    #FxChargeMuzzleFlash = {
		#'/mods/BlackOpsFAF-Unleashed/effects/emitters/xcannon_muzzle_charge_01_emit.bp',
		#'/mods/BlackOpsFAF-Unleashed/effects/emitters/xcannon_muzzle_charge_02_emit.bp',#blue glow
        #'/mods/BlackOpsFAF-Unleashed/effects/emitters/xcannon_muzzle_charge_05_emit.bp',#purple glow
    #},
    #FxMuzzleFlash = {
	#	'/mods/BlackOpsFAF-Unleashed/effects/emitters/xcannon_cannon_muzzle_01_emit.bp',--#large redish flash
	#	'/mods/BlackOpsFAF-Unleashed/effects/emitters/x_cannon_fire_test_01_emit.bp',--barrel lightning effect
	#	'/mods/BlackOpsFAF-Unleashed/effects/emitters/xcannon_cannon_muzzle_07_emit.bp',-- small redish flash, double quick
	#	'/mods/BlackOpsFAF-Unleashed/effects/emitters/xcannon_cannon_muzzle_08_emit.bp',-- small redish double flash
	#},
...
ShadowCannonWeapon01 = Class(DefaultProjectileWeapon) {
    ...
    FxMuzzleFlash = {
		...
		#'/mods/BlackOpsFAF-Unleashed/effects/emitters/shadow_cannon_muzzle_03_emit.bp',
		#'/mods/BlackOpsFAF-Unleashed/effects/emitters/shadow_cannon_muzzle_04_emit.bp',
...
BassieCannonWeapon01 = Class(DefaultProjectileWeapon) {
    ...
    FxMuzzleFlash = {
		...
		#'/mods/BlackOpsFAF-Unleashed/effects/emitters/bassie_cannon_muzzle_03_emit.bp',
		#'/mods/BlackOpsFAF-Unleashed/effects/emitters/bassie_cannon_muzzle_04_emit.bp',
