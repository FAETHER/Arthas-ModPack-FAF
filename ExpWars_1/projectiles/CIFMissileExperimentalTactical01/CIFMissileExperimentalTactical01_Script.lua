...
CIFMissileTactical01 = Class(CLOATacticalMissileProjectile) {
    ...
    OnImpact = function(self, TargetType, TargetEntity) 
        ...
        local ChildProjectileBP = '/Mods/ExpWars_1/projectiles/CIFMissileTacticalSplit02/CIFMissileTacticalSplit02_proj.bp'  
        ...
        local angleVariation = angle * 1.95 # Adjusts angle variance spread
        local spreadMul = 1.95 # Adjusts the width of the dispersal        
