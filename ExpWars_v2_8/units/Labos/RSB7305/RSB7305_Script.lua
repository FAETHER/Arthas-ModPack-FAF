--[[#######################################################################
#  File     :  /units/Labos/RSB7305/RSB7305_script.lua
#  Author(s):  GPG Devs
...
RSB7305 = Class( SLandResearchLabUnit ) {
	SwitchAnims = true,
    ...
    OnCreate = function(self)
		...
		self.Rotator18 = CreateRotator(self, 'B17', 'y', nil, -85, 0, 0)
		self.Trash:Add(self.Rotator18)
		self.Rotator19 = CreateRotator(self, 'B18', 'y', nil, -85, 0, 0)
        self.Trash:Add(self.Rotator19)
		self.Rotator20 = CreateRotator(self, 'B19', 'y', nil, -85, 0, 0)
        self.Trash:Add(self.Rotator20)
    ...
    OnKilled = function(self, instigator, type, overkillRatio)
		...
		self.Rotator18:SetSpeed(0)
		self.Rotator19:SetSpeed(0)
		self.Rotator20:SetSpeed(0)
    ...
    OnStopBeingBuilt = function(self,builder,layer)
        ...
        for k, v in SeraphimAirStagePlat01 do
			...
			CreateAttachedEmitter(self, 'B18', self:GetArmy(), v)
			CreateAttachedEmitter(self, 'B19', self:GetArmy(), v)
			CreateAttachedEmitter(self, 'B17', self:GetArmy(), v)
        end
