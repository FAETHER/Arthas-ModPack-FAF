...
TDFGoliathCollisionBeam = Class(HawkCollisionBeam) {
    ...
    TerrainImpactScale = 1,
    FxBeamEndPoint = {
		'/mods/BlackOpsFAF-Unleashed/effects/emitters/goliath_death_laser_end_01_emit.bp',			# big glow
		'/mods/BlackOpsFAF-Unleashed/effects/emitters/goliath_death_laser_end_02_emit.bp',			# random bright blueish dots
		...
		'/mods/BlackOpsFAF-Unleashed/effects/emitters/goliath_death_laser_end_06_emit.bp',			# upward sparks
		'/effects/emitters/uef_orbital_death_laser_end_07_emit.bp',			# outward line streaks
		'/mods/BlackOpsFAF-Unleashed/effects/emitters/goliath_death_laser_end_08_emit.bp',			# center glow
    ...
    FxBeamStartPoint = {
		'/mods/BlackOpsFAF-Unleashed/effects/emitters/goliath_death_laser_muzzle_01_emit.bp',	# random bright blueish dots
		'/mods/BlackOpsFAF-Unleashed/effects/emitters/goliath_death_laser_muzzle_02_emit.bp',	# molecular, small details
		'/mods/BlackOpsFAF-Unleashed/effects/emitters/goliath_death_laser_muzzle_03_emit.bp',	# darkening lines
		'/mods/BlackOpsFAF-Unleashed/effects/emitters/goliath_death_laser_muzzle_04_emit.bp',	# small downward sparks
		'/mods/BlackOpsFAF-Unleashed/effects/emitters/goliath_death_laser_muzzle_05_emit.bp',	# big glow
    },
