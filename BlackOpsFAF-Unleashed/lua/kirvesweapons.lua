...
local EffectTemplate = import('/mods/BlackOpsFAF-Unleashed/lua/kirveseffects.lua')

local CollisionBeamFile = import('/mods/BlackOpsFAF-Unleashed/lua/kirvesbeams.lua')
