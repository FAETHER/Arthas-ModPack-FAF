--[[#######################################################################
#  File     :  /hook/lua/EW_DefaultUnits.lua
#  Author(s):  Manimal
...
# DE LA CLASSE Unit LIÉES À OnKilled ET OnDestroy (voir /hook/lua/sim/Unit.lua)
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
]]--

local Unit = import( MyModPath .. '/hook/lua/sim/Unit.lua' ).Unit
local DefaultUnits = import( MyModPath .. '/hook/lua/defaultunits.lua' )
local DefaultStructureUnit = DefaultUnits.StructureUnit
local DefaultFactoryUnit = DefaultUnits.FactoryUnit
local DefaultLandFactoryUnit = DefaultUnits.LandFactoryUnit
...
NiveauVetMax = Game.NiveauVetMax
...
PortalFactoryUnit = Class( DefaultLandFactoryUnit ) {
    ...
    OnCreate = function( self )
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		local message = '\n\nMANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PFU -> OnCreate : '
    ...
    OnReclaimed = function( self, entity )
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PFU  ->  OnReclaimed  :  UNITE RECYCLEE ' .. tostring(idUnite) .. '  PAR  ' .. tostring(idEntity) .. '\n' )
 		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   end,
    ...
    OnKilled = function( self, instigator, type, overkillRatio )
		...
		local idUnite = self:GetUnitId() or "UNITE INCONNUE"
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PFU  ->  OnKilled  :  ' .. idUnite .. '  instigator = ' .. tostring(instigator) .. '  type = ' .. tostring(type) )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PFU  ->  OnKilled  :  PORTAIL -> UNITE EN CONSTRUCTION ' .. tostring(uBBid) .. ' !!!\n' )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		end
    ...
    OnDestroy = function( self )
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PFU  ->  OnDestroy  :' )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		...
		if  EstUneEntiteUnique( self )  and  EstUnPortail( self )  then
			...
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PFU  ->  OnDestroy  :  armee = ' .. tostring(armee) .. '  UnitId Portail = ' .. tostring(idUnite) ..  '  SyncId Portail = '.. tostring(idEntite) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			...
			local zeUBC = false
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PFU  ->  OnDestroy  :  idPerePortail = ' .. tostring(self.idPerePortail) .. '  (type = ' .. type(self.idPerePortail) .. ')' )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

			if  self.idPerePortail  and  self.idPerePortail != nil  and  self.idPerePortail != false  then
				zeUBC = GetUnitById( self.idPerePortail )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
				LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PFU  ->  OnDestroy  :  zeUBC -> Sync.id = ' .. tostring(zeUBC.Sync.id) .. '  (type = ' .. type(zeUBC.Sync.id) .. ')   Sync.army = ' .. tostring(zeUBC.Sync.army) .. '  (type = ' .. type(zeUBC.Sync.army) .. ')' )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			end
			if  zeUBC  and  zeUBC != nil  and  not zeUBC:IsDead()  then
				...
				#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
				LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PFU  ->  OnDestroy  :  SIGNAL UBC = Portail MORT !' )
				#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			end

		end
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PFU  ->  OnDestroy  :  PORTAIL MORT !\n\n' )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    OnStartBeingBuilt = function( self, builder, layer )
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PFU  ->  OnStartBeingBuilt  :' )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		...
		if  EstUneEntiteUnique( self )  and  EstUnPortail( self )  then
			...
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PFU  ->  OnStartBeingBuilt  :  CONSTRUCTION DE PORTAIL '.. tostring(idUnite) .. '  PAR  ' .. tostring(idUniteBuilder) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			...
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PFU  ->  OnStartBeingBuilt  :  builder -> idHeros = ' .. tostring(builder.idHeros) .. '  (type = ' .. type(builder.idHeros) .. ')' )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			...
			if  zeHEROS != false  and  zeHEROS != nil  and  not zeHEROS:IsDead()  then
				...
				#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
				LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PFU  ->  OnStartBeingBuilt  :  ADOPTION HEROS Orphelin du Portail !' )
				#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			end

		end
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PFU  ->  OnStartBeingBuilt  :  PORTAIL EN COURS de CONSTRUCTION !\n' )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    OnFailedToBuild = function( self )
		...
		local idUnite = self:GetUnitId() or "UNITE INCONNUE"
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PFU  ->  OnFailedToBuild  :  ' .. tostring(idUnite) )
    end,
...
HeroWalkingLandUnit = Class( DefaultWalkingLandUnit ) {
    ...
    OnCreate = function( self )
		...
		local message = '\n\nMANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnCreate : '
    ...
    OnReclaimed = function( self, entity )
		...
		local idUnite = self:GetUnitId() or "UNITE INCONNUE"
		local idEntity = entity:GetUnitId() or "UNITE INCONNUE"
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnReclaimed  :  UNITE RECYCLEE ' .. tostring(idUnite) .. '  PAR  ' .. tostring(idEntity) .. '\n' )
    end,
    ...
    OnKilled = function( self, instigator, type, overkillRatio )
		...
		local idUnite = self:GetUnitId() or "UNITE INCONNUE"
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnKilled  :  ' .. tostring(idUnite) .. '  instigator = ' .. tostring(instigator) .. '  type = ' .. tostring(type) .. '\n' )
    end,


    OnDestroy = function( self )

		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnDestroy : ' )
		...
		if IsUnit( self ) and EstUneEntiteUnique( self ) and EstUnHeros( self ) then
			...
			local idEntite = self.Sync.id or "IDENTIF. INCONNUE"
			local armee = self:GetArmy()
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnDestroy :  armee = ' .. tostring(armee) .. '  UnitId Heros = ' .. tostring(idUnite) ..  '  SyncId Heros = '.. tostring(idEntite) )

			# NOTIFICATION DU CONSTRUCTEUR DU HÉROS (PORTAIL)
			# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnDestroy  :  idPereHeros = ' .. tostring(self.idPereHeros) .. '  (type = ' .. type(self.idPereHeros) .. ')' )
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnDestroy  :  idPerePortail = ' .. tostring(self.idPerePortail) .. '  (type = ' .. type(self.idPerePortail) .. ')' )

			local zePORTAIL = false
			if  self.idPereHeros  and  self.idPereHeros != nil  then
				zePORTAIL = GetUnitById( self.idPereHeros )
				LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnDestroy  :  zePORTAIL -> Sync.id = ' .. tostring(zePORTAIL.Sync.id) .. '  (type = ' .. type(zePORTAIL.Sync.id) .. ')   Sync.army = ' .. tostring(zePORTAIL.Sync.army) .. '  (type = ' .. type(zePORTAIL.Sync.army) .. ')' )
			end
			...
			if  zePORTAIL != false  and  zePORTAIL != nil  and  not zePORTAIL:IsDead()  then
				...
				LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnDestroy  :  SIGNAL Portail = Heros EST MORT !\n' )
			end
			...
			if  self.idPerePortail  and  self.idPerePortail != nil  then
				zeUBC = GetUnitById( self.idPerePortail )
				LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnDestroy  :  zeUBC -> Sync.id = ' .. tostring(zeUBC.Sync.id) .. '  (type = ' .. type(zeUBC.Sync.id) .. ')   Sync.army = ' .. tostring(zeUBC.Sync.army) .. '  (type = ' .. type(zeUBC.Sync.army) .. ')' )
			end

			if  zeUBC != false  and  zeUBC != nil  and  not zeUBC:IsDead()  then
				zeUBC.idHeros = false --# INFORMER UBC : HÉROS MORT

				LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnDestroy  :  SIGNAL UBC = Heros EST MORT !' )
			end

		end

		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnDestroy  :  SIGNAL HEROS DISPO !\n\n' )
    ...
    OnStartBeingBuilt = function(self, builder, layer)
		...
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnStartBeingBuilt  :  ' )
		...
		if IsUnit( self ) and EstUneEntiteUnique( self ) and EstUnHeros( self ) then
			...
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnStartBeingBuilt  :  CONSTRUCTION DE HEROS '.. tostring(idUnite) .. '  PAR  ' .. tostring(idUniteBuilder) )
			...
			# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			local zeUBC = false
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnStartBeingBuilt  :  builder -> idPerePortail = ' .. tostring(builder.idPerePortail) .. '  (type = ' .. type(builder.idPerePortail) .. ')' )
			...
			if  builder.idPerePortail  and  builder.idPerePortail != nil  then
				...
				LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnStartBeingBuilt  :  zeUBC -> Sync.id = ' .. tostring(zeUBC.Sync.id) .. '  (type = ' .. type(zeUBC.Sync.id) .. ')   Sync.army = ' .. tostring(zeUBC.Sync.army) .. '  (type = ' .. type(zeUBC.Sync.army) .. ')' )
			end
			if  zeUBC != false  and  zeUBC != nil  and  not zeUBC:IsDead()  then
				zeUBC.idHeros = self.Sync.id  --# SIGNALER NOUVEAU HÉROS !
				LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnStartBeingBuilt  :  SIGNAL UBC = NOUVEAU Heros !' )
			end

		end
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnStartBeingBuilt  :  SIGNAL HEROS INDISPONIBLE !\n' )
    ...
    OnFailedToBuild = function( self )
		...
		local idUnite = self:GetUnitId() or "UNITE INCONNUE"
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  HeroWalkingLandUnit  ->  OnFailedToBuild  :  ' .. tostring(idUnite) )
...
VeteranFactoryUnit = Class( StructureUnit ) {
	...
	IndexUniteDansListeSyncUsines = function( self )
		...
		if  table.getsize( ListeSyncUsines ) <= 0  then
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  IndexUniteDansListeSyncUsines  :  LISTE SYNC VIDE POUR ARMEE ' .. tostring(self.Sync.army) .. '  !!!  ListeSyncUsines = ' .. repr(ListeSyncUsines) .. ' ' )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	AjouterUniteDansListeSyncUsines = function( self )
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  AjouterUniteDansListeSyncUsines  :  UNITE ' .. tostring(self:GetUnitId()) .. '  ID ' .. tostring(self.Sync.id) .. ' ARMEE ' .. tostring(self.Sync.army) .. '  ' .. nomType[typeBatiment] .. '  TECH' .. tostring(niveauTech) )
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  AjouterUniteDansListeSyncUsines  :  LISTE SYNC  AVANT = ' .. repr(ListeSyncUsines) )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		...
		if  indexUnite == nil  then
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  AjouterUniteDansListeSyncUsines  :  PROBLÈME => VÉRIFIER LE SCRIPT OU LA FONCTION IndexUniteDansListeSyncUsines !!!  indexUnite = ' .. tostring(indexUnite) .. '  (type = ' .. type(indexUnite) .. ')  #  ListeSyncUsines = ' .. repr(ListeSyncUsines) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			return false
		end
		...
		if  EstUnBooleen( indexUnite )  and  indexUnite == false  then
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  AjouterUniteDansListeSyncUsines  :  LISTE SYNC VIDE (false) => AUCUN PROBLEME !!!  indexUnite = ' .. tostring(indexUnite) .. '  (type = ' .. type(indexUnite) .. ')  #  ListeSyncUsines = ' .. repr(ListeSyncUsines) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		end
		...
		if  EstUnNombre( indexUnite )  and  indexUnite == 0  then
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  AjouterUniteDansListeSyncUsines  :  ID UNITE NON REPERTORIE => AUCUN PROBLEME !!!  indexUnite = ' .. tostring(indexUnite) .. '  (type = ' .. type(indexUnite) .. ')  #  ListeSyncUsines = ' .. repr(ListeSyncUsines) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		end
		...
		if  EstUnNombre( indexUnite )  and  indexUnite > 0  then
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  AjouterUniteDansListeSyncUsines  :  ID UNITE DEJA REPERTORIE !!!  indexUnite = ' .. tostring(indexUnite) .. '  (type = ' .. type(indexUnite) .. ')  #  ListeSyncUsines = ' .. repr(ListeSyncUsines) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			return false
		end
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  AjouterUniteDansListeSyncUsines  :  ListeSyncUsines  APRES = ' .. repr(ListeSyncUsines) )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	RetirerUniteDansListeSyncUsines = function( self )
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  RetirerUniteDansListeSyncUsines  :  UNITE ' .. tostring(self:GetUnitId()) .. '  id ' .. tostring(self.Sync.id) .. ' ARMEE ' .. tostring(self.Sync.army) .. '  [' .. nomType[typeBatiment] .. '][TECH' .. tostring(niveauTech) ..  ']' )
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  RetirerUniteDansListeSyncUsines  :  ListeSyncUsines  AVANT = ' .. repr(ListeSyncUsines) )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		...
		if  indexUnite == nil  then
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  RetirerUniteDansListeSyncUsines  :  PROBLÈME => VÉRIFIER LE SCRIPT OU LA FONCTION IndexUniteDansListeSyncUsines !!!  indexUnite = ' .. tostring(indexUnite) .. '  #  ListeSyncUsines = ' .. repr(ListeSyncUsines) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			return false
		end
		...
		if  EstUnBooleen( indexUnite )  and  indexUnite == false  then
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  RetirerUniteDansListeSyncUsines  :  LISTE SYNC VIDE => RIEN À RETIRER DE LA LISTE !!!  indexUnite = ' .. tostring(indexUnite) .. '  #  ListeSyncUsines = ' .. repr(ListeSyncUsines) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			return false
		end
		...
		if  EstUnNombre( indexUnite )  and  indexUnite == 0  then
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  RetirerUniteDansListeSyncUsines  :  ID UNITE INEXISTANT => RIEN À RETIRER DE LA LISTE !!!  indexUnite = ' .. tostring(indexUnite) .. '  #  ListeSyncUsines = ' .. repr(ListeSyncUsines) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			return false
		end
		...
		if  EstUnNombre( indexUnite )  and  indexUnite > 0  then
			...
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  RetirerUniteDansListeSyncUsines  : ID UNITE NON REPERTORIE  ->  ListeSyncUsines  APRES  = ' .. repr(ListeSyncUsines) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		end

		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  RetirerUniteDansListeSyncUsines  :  VERIF  ListeSyncUsines  APRES  = ' .. repr(ListeSyncUsines) )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
--# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~]]--
	...
	ActualiserNiveauVeteranUsine = function( self, constructeur )
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  ActualiserNiveauVeteranUsine  :  M à J de NiveauxVeteran  ->  ARMY = ' .. tostring(self.Sync.army) .. '  self.Sync.id = ' .. tostring(self.Sync.id) .. '  constructeur.Sync.id = ' .. tostring(constructeur.Sync.id) .. '  =>  self.NiveauxVeteran = ' .. repr(self.NiveauxVeteran) .. ' #' )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		...
		if  table.getsize( ListeSyncLabos ) <= 0  then
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  ActualiserNiveauVeteranUsine  :  LISTE SYNC VIDE => FIN DE FONCTION  POUR ARMÉE ' .. tostring(self.Sync.army) .. '  !!!  ListeSyncLabos = ' .. repr(ListeSyncLabos) .. ' ' )
		...
		if  idLabo == nil  then
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  ActualiserNiveauVeteranUsine  :  LISTE SYNC LABOS NON INITIALISÉE => IMPOSSIBLE DE CONTINUER !!! !!!  ListeSyncLabos = ' .. repr(ListeSyncLabos) .. ' ' )
			return false
		end
		...
		if  EstUnBooleen( idLabo )  and  idLabo == false  then  --# LABO PAS OBLIGATOIREMENT CONSTRUIT 
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  ActualiserNiveauVeteranUsine  :  ID LABO NON RÉPERTORIÉ DANS LA LISTE => RIEN À EXPLOITER !!!  ListeSyncLabos = ' .. repr(ListeSyncLabos) .. ' ' )
			return false
		end

		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  ActualiserNiveauVeteranUsine  :  idLabo = ' .. tostring(idLabo) .. '  POUR JOUEUR  [ARMY' .. tostring(self.Sync.army) .. '][' .. tostring(nomType[typeBatiment]) .. '][TECH' .. tostring(niveauTech) .. ']' )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		...
		if  idLabo  and  idLabo != nil  and  idLabo != ""  then  --# LABO PAS OBLIGATOIREMENT CONSTRUIT !
			...
			if  zeLAB != false  and  zeLAB != nil  and  not zeLAB:IsDead()  and  idArmee == zeLAB.Sync.army  then  --# LABO PAS OBLIGATOIREMENT CONSTRUIT !
				...
				LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  ActualiserNiveauVeteranUsine  :  LABO RETROUVÉ  zeLAB.Sync.id = ' .. tostring(zeLAB.Sync.id) .. '  DE NIVEAU TECH = ' .. tostring(niveauTechLabo) .. '  =>  NIVEAU RECHERCHE = ' .. tostring(niveauDeRecherche) .. '  self.NiveauxVeteran = ' .. repr(self.NiveauxVeteran) .. '' )
				#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			end
		end  --# END IF  idLabo
...
--# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~]]--
	...
	FixerNiveauVeteranUsineSurUnite = function( self, unite )
		...
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  FixerNiveauVeteranUsineSurUnite  :  USINE = ' .. tostring( selfUnId ) .. '  ARMEE = ' .. tostring( self.Sync.army ) .. '  UNITE = ' .. tostring( uBBid ) .. '  niveauTechUnite = ' .. tostring( niveauTechUnite ) .. '  niveauVeteran = ' .. tostring( niveauVeteran ) .. '  #  self.NiveauxVeteran = ' .. repr( self.NiveauxVeteran ) )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
--[[
	...
	OnStartBeingBuilt = function( self, builder, layer )
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( '\n\nMANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  OnStartBeingBuilt  :  PERE USINE self -> idPereDeUsine = ' .. tostring(self.idPereDeUsine) .. '  (type = ' .. type(self.idPereDeUsine) .. ')   Sync.army = ' .. tostring(self.Sync.army) .. '  (type = ' .. type(self.Sync.army) .. ')' )
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  OnStartBeingBuilt  :  PERE USINE builder -> Sync.id = ' .. tostring(builder.Sync.id) .. '  (type = ' .. type(builder.Sync.id) .. ')   Sync.army = ' .. tostring(builder.Sync.army) .. '  (type = ' .. type(builder.Sync.army) .. ')' )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		--#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
--[[
    ...
    OnStopBeingBuilt = function( self, builder, layer )
		...
		if  fractionComplete == 1  then  --# ASSURANCE QUE UPGRADE EST TERMINÉ
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  OnStopBeingBuilt  :  PERE USINE builder -> Sync.id = ' .. tostring(builder.Sync.id) .. '  (type = ' .. type(builder.Sync.id) .. ')   Sync.army = ' .. tostring(builder.Sync.army) .. '  (type = ' .. type(builder.Sync.army) .. ')' )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
--# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~]]--
	...
	--#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( '\n\nMANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  OnStartBuild  :  PERE USINE self -> idPereDeUsine = ' .. tostring(self.idPereDeUsine) .. '  (type = ' .. type(self.idPereDeUsine) .. ')   Sync.army = ' .. tostring(self.Sync.army) .. '  (type = ' .. type(self.Sync.army) .. ')' )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		local zePERE = false
		if  self.idPereDeUsine  and  self.idPereDeUsine != nil  then
			zePERE = GetUnitById( self.idPereDeUsine )
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  OnStartBuild  :  zePERE -> Sync.id = ' .. tostring(zePERE.Sync.id) .. '  (type = ' .. type(zePERE.Sync.id) .. ')   Sync.army = ' .. tostring(zePERE.Sync.army) .. '  (type = ' .. type(zePERE.Sync.army) .. ')' )
		end
	--#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    end,
...
--[[
    ...
    OnStopBuild = function( self, unitBeingBuilt, order )
		...
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  VFU  ->  OnStopBuild  :  ARMEE ' .. tostring( self.Sync.army ) .. '  USINE ' .. tostring( selfUnId ) .. '  ORDRE ' .. tostring( order ) .. '  UNITE ' .. tostring( uBBid ) .. ' !'  )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
PorteQuantiqueUnit = Class( VeteranFactoryUnit ) {
    ...
    OnStopBuild = function( self, unitBeingBuilt, order )
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PQU  ->  OnStopBuild  :  PORTE QUANTIQUE ' .. tostring(self:GetUnitId()) .. '  ID ' .. tostring(self.Sync.id) .. ' ARMEE ' .. tostring(self.Sync.army) .. '  unitBeingBuilt ' .. tostring(unitBeingBuilt:GetUnitId()) .. ' CONSTRUITE !' )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
--[[#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    TeleportOffUnit = function( self )
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PQU  ->  TeleportOffUnit  :  PORTE QUANTIQUE ' .. tostring(self:GetUnitId()) .. '  ID ' .. tostring(self.Sync.id) .. ' ARMEE ' .. tostring(self.Sync.army) .. '  UNITE ' .. tostring(unite:GetUnitId()) .. '  ID ' .. tostring(unite.Sync.id) .. ' Va Etre Teleportee !' )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		...
		unite.AppliquerDegatsTeleportation = function( self )
			...
			if  self.CanBeKilled  then
				...
				#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
				LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  UNIT VIA PQU  ->  TeleportOffUnit  :  unite.AppliquerDegatsTeleportation  >  HEALTH ' .. tostring(health) .. '  NEW HEALTH ' .. tostring(newHealthAmount) .. ' ARMEE ' .. tostring(self.Sync.army) .. '  UNITE ' .. tostring(unite:GetUnitId()) .. '  ID ' .. tostring(unite.Sync.id) .. ' LE TÉLÉPORTÉ VIENT DE MORFLER !' )
			...
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  ENNEMIS VIA PQU  ->  TeleportOffUnit  :  unite.AppliquerDegatsTeleportation  >  BP TEL DMG AMNT ' .. tostring(bpTelDmgAmnt) .. '  TEL DMG AMOUNT ' .. tostring(telDmgAmount) .. ' ARMEE ' .. tostring(self.Sync.army) .. ' LES UNITÉS PROCHES DU TÉLÉPORTÉ VIENNENT DE MORFLER !' )
			--local FloatingEntityText = import('/schook/lua/SimSync.lua').FloatingEntityText
			...
			WaitSeconds(0.1)
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  UNIT VIA PQU  ->  unite.PlayTeleportInEffects  :  AppliquerDegatsTeleportation DEPUIS UNITE ' .. tostring(self:GetUnitId()) .. '  ID ' .. tostring(self.Sync.id) .. ' ARMEE ' .. tostring(self.Sync.army) .. '  #####' )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		end
		...
		unite.PlayTeleportOutEffects = function( self )
			...
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  UNIT VIA PQU  ->  unite.PlayTeleportOutEffects  :  UNITE ' .. tostring(self:GetUnitId()) .. '  ID ' .. tostring(self.Sync.id) .. ' ARMEE ' .. tostring(self.Sync.army) .. '  #####' )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		end
		...
		unite.PlayTeleportInEffects = function( self )
			...
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  UNIT VIA PQU  ->  unite.PlayTeleportInEffects  :  UNITE ' .. tostring(self:GetUnitId()) .. '  ID ' .. tostring(self.Sync.id) .. ' ARMEE ' .. tostring(self.Sync.army) .. '  #####' )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			...
			self:CreateProjectile( MyModPath .. '/hook/effects/entities/UnitTeleport06/UnitTeleport06_proj.bp', 0, 1.35, 0, nil, nil, nil ):SetCollision( false )
			WaitSeconds( 2 )
    ...
    TeleportingOffState = State {
        Main = function( self )
			...
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  PQU  ->  TeleportingOffState  :  PORTE QUANTIQUE ' .. tostring(self:GetUnitId()) .. '  ID ' .. tostring(self.Sync.id) .. ' ARMEE ' .. tostring(self.Sync.army) .. '  UNITE ' .. tostring(unite:GetUnitId()) .. '  ID ' .. tostring(unite.Sync.id) .. ' TELEPORTEE !' )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        end,
    },
...
LaboStructureUnit = Class( StructureUnit ) {
    ...
    OnCreate = function( self )
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		local message = '\n\nMANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnCreate  :  '
		
		--LOG (" !EstUneEntiteUnique ")
		...
		if  EstUneEntiteUnique( self ) and  EstUnLabo( self )  then
			...
			local idEntite = self.Sync.id or "IDENTIF. INCONNUE"
		-- BUGFIX BY ETHERR --------------------------------------------------------------------------------------------------
		-- This flag is not defined! Causes to have errors. Commented out. 
			...
			-- if EstNonCapturable( self ) then
				...
				-- message = message .. '  EstNonCapturable'
			-- end
			message = message .. '\nMANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnCreate  :  armee = ' .. tostring(armee) .. '  UnitId Labo = '.. tostring(idUnite) .. '  SyncId Labo = '.. tostring(self.Sync.id) .. '\n'
		end
		LOG( message )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    end,
	...
	IndexUniteDansListeSyncLabos = function( self )
		...
		if  table.getsize( ListeSyncLabos ) <= 0  then
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  IndexUniteDansListeSyncLabos  :  LISTE SYNC VIDE POUR ARMÉE ' .. tostring(self.Sync.army) .. '  !!!  ListeSyncLabos = ' .. repr(ListeSyncLabos) .. ' ' )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			return false  --# LISTE SYNC VIDE !!!
		end
	...
	AjouterUniteDansListeSyncLabos = function( self )
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  AjouterUniteDansListeSyncLabos  :  UNITE ' .. tostring(self:GetUnitId()) .. '  ID ' .. tostring(self.Sync.id) .. ' ARMEE ' .. tostring(self.Sync.army) .. '  [' .. nomType[typeBatiment] .. '][TECH' .. tostring(niveauTech) ..  ']' )
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  AjouterUniteDansListeSyncLabos  :  LISTE SYNC  AVANT = ' .. repr(ListeSyncLabos) )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		...
		if  indexUnite == nil  then
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  AjouterUniteDansListeSyncLabos  :  FONCTION IndexUniteDansListeSyncLabos MAL UTILISÉE => VÉRIFIER LE SCRIPT !!!' )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			return false
		end
...
--[[
		...
		if  EstUnBooleen( indexUnite )  and  indexUnite == false  then
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  AjouterUniteDansListeSyncLabos  :  LISTE SYNC VIDE => AUCUN PROBLEME !!!    ListeSyncLabos = ' .. repr(ListeSyncLabos) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		end
		...
		if  EstUnNombre( indexUnite )  and  indexUnite == 0  then
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  AjouterUniteDansListeSyncLabos  :  ID UNITE NON REPERTORIE => AUCUN PROBLEME !!!    ListeSyncLabos = ' .. repr(ListeSyncLabos) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		end
]]--
		...
		if  EstUnNombre( indexUnite )  and  indexUnite > 0  then
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			WARN( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  AjouterUniteDansListeSyncLabos  :  ID UNITE TROUVE !!!    ListeSyncLabos = ' .. repr(ListeSyncLabos) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			return false
		end
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  AjouterUniteDansListeSyncLabos  :  ListeSyncLabos  APRES = ' .. repr(ListeSyncLabos) )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	RetirerUniteDansListeSyncLabos = function( self )
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  RetirerUniteDansListeSyncLabos  :  UNITE ' .. tostring(self:GetUnitId()) .. '  id ' .. tostring(self.Sync.id) .. ' ARMEE ' .. tostring(self.Sync.army) .. '  [' .. nomType[typeBatiment] .. '][TECH' .. tostring(niveauTech) ..  ']' )
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  RetirerUniteDansListeSyncLabos  :  ListeSyncLabos  AVANT = ' .. repr(ListeSyncLabos) )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		...
		if  indexUnite == nil  then
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  RetirerUniteDansListeSyncLabos  :  LISTE SYNC NON INITIALISEE => REVOIR UTILISATION DE LA FONCTION IndexUniteDansListeSyncLabos    ListeSyncLabos = ' .. repr(ListeSyncLabos) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			return false
		end
		...
		if  EstUnBooleen( indexUnite )  and  indexUnite == false  then
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  RetirerUniteDansListeSyncLabos  :  LISTE SYNC VIDE => RIEN A RETIRER DE LA LISTE !!!    EstUnBooleen( indexUnite ) = ' .. tostring(EstUnBooleen(indexUnite)) .. ' (type = ' .. type(EstUnBooleen(indexUnite)).. ')  #  ListeSyncLabos = ' .. repr(ListeSyncLabos) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			return false
		end
		...
		if  EstUnNombre( indexUnite )  and  indexUnite == 0  then
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  RetirerUniteDansListeSyncLabos  :  ID UNITE NON REPERTORIE => RIEN A RETIRER DE LA LISTE !!!    EstUnBooleen( indexUnite ) = ' .. tostring(EstUnBooleen(indexUnite)) .. ' (type = ' .. type(EstUnBooleen(indexUnite)).. ')  #  ListeSyncLabos = ' .. repr(ListeSyncLabos) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			return false
		end
		...
		if  EstUnNombre( indexUnite )  and  indexUnite > 0  then
			...
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  RetirerUniteDansListeSyncLabos  :   ID UNITÉ REPERTORIE !!!  ListeSyncLabos  APRES  = ' .. repr(ListeSyncLabos) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		end

		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  RetirerUniteDansListeSyncLabos  :   VERIF  ListeSyncLabos  APRES  = ' .. repr(ListeSyncLabos) )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	InfosDeLaRecherche = function( self )
		...
		if  not infosDeRecherche  or  infosDeRecherche == nil  or  table.getsize( infosDeRecherche ) <= 0  then
			WARN( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  InfosDeLaRechercheDansLabo  :  ERREUR: infosDeRecherche (' .. type( infosDeRecherche ) .. '), DEVRAIT UNE TABLE NON VIDE !\n' )
...
--[[
	...
	AppliquerRechercheSurUsines = function( self )
		...
		if  table.getsize( ListeSyncUsines ) <= 0  then 
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  AppliquerRechercheSurUsines  :  LISTE SYNC VIDE => FIN DE FONCTION  POUR ARMÉE ' .. tostring(idArmee) .. '  TYPE  ' .. tostring(typeBatiment) .. '  TECH' .. tostring(niveauTech) .. ' !!!  ListeSyncUsines = ' .. repr(ListeSyncUsines) .. ' ' )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			return false
		end  --# POUR GESTION ERREUR

		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  AppliquerRechercheSurUsines  :  ListeSyncUsines  ARMEE ' .. tostring(idArmee) .. '  ' .. nomType[typeBatiment] .. '  TECH ' .. tostring(niveauTech) .. '  = ' .. repr(ListeSyncUsines) .. ' (type = ' .. type(ListeSyncUsines) .. ')' )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

		--# SCAN TOUTES USINES !!! ( PAS DE break ! )
		for index, uneSync in ipairs( ListeSyncUsines ) do
			--#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			--LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  AppliquerRechercheSurUsines  :  ARMEE ' .. tostring(idArmee) .. '  uneSync = ' .. repr(uneSync) .. '  uneSync.id ' .. tostring(uneSync.id) .. '  uneSync.army ' .. tostring(uneSync.army) .. '  uneSync.type = ' .. tostring(uneSync.type) .. ' = ' .. nomType[uneSync.type] .. '  uneSync.tech ' .. tostring(uneSync.tech) )
			--#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			...
			--and  uneSync.tech  and  uneSync.tech != nil  and  uneSync.tech == niveauTech  then
				...
				if  uneUsine  and  uneUsine != nil  and  not uneUsine:IsDead()  then
					...
					if  niveauDeRecherche  and  niveauDeRecherche > 0  then
						...
						#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
						LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  AppliquerRechercheSurUsines  :  niveauDeRecherche = ' .. tostring(niveauDeRecherche) .. '  SUR  uneUsine ' .. tostring(uneUsine:GetUnitId()) .. '  ID ' .. tostring(uneUsine.Sync.id) .. '  ARMEE ' .. tostring(idArmee) .. '  [' .. nomType[typeBatiment] .. '][TECH' .. tostring(niveauTech) ..  '] #' )
						LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  AppliquerRechercheSurUsines  :  uneUsine.NiveauxVeteran = ' .. repr( uneUsine.NiveauxVeteran ) )
						#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    OnResearchCompleted = function( self, uniteArech, initiateur )
		...
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnResearchCompleted  :  Labo  ' .. tostring(selfUnId) .. '  >  RECHERCHE EN COURS [' .. nomRecherche .. ']  DE NIVEAU [' .. tostring(niveauRecherche) .. ']  PAR  [' .. tostring(iniUid) .. ']  >  REUSSIE ! ' )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    OnStartBeingBuilt = function( self, builder, layer )
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnStartBeingBuilt  :  CONSTRUCTION DE LABO '.. tostring(idUnite) .. '  PAR  ' .. tostring(idUniteBuilder) .. '  SUR  ' .. tostring(layer) )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		...
		if  builder  and  builder != nil  and  not builder:IsDead()  then
			...
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnStartBeingBuilt  :  PREMIER LABO VERIF  LaboReInit = ' .. repr(LaboReInit) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			...
			if  EntityCategoryContains( catCmndr, builder )  then
				...
				local typeBatiment = IndexTypeUnite( self )
				local niveauTech = IndexTechUnite( self )
				--# NIVEAU TECH CAR BLOCAGE PARTIEL || LEVEL TECH CAR BLOCKING PARTIAL
				...
				-- FIND THE LAB TO REBUILD. Assume LaboReInit Was Initiated Properly
				--# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
				...
				if  laboBpid == false  then  --# PREMIÈRE CONSTRUCTION PAR UBC DE TOUS NIVEAUX
				    --FIRST CONSTRUCTION BY UBC OF ALL LEVELS
					--# NOTIFIER UBC DE RESTRICTION DU LABO DEJA CONSTRUIT
					--# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
				local catHerosDetruit = CategorieIdUnite( idUnite )
				PermettreConstructionParCategorie( builder, catHerosDetruit ) 

					#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
					LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnStartBeingBuilt  :  EST PREMIERE CONSTRUCTION  laboBpid ' .. tostring(laboBpid) .. '  ARMEE ' .. tostring(idArmee) .. '  LaboReInit = ' .. repr(LaboReInit) )
					#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
				...
				elseif  laboBpid != false  and  laboBpid != nil  then  --# RECONSTRUCTION
					...
					--RECONSTRUCTION- # NOTIFY UBC RESTRICTION OF RECONSTRUCTED LAB, NOT THE SAME LEVEL TECH
					--# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
					local catHerosDetruit = CategorieIdUnite( idUnite )
					PermettreConstructionParCategorie( builder, catHerosDetruit ) 

					#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
					LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnStartBeingBuilt  :  EST RECONSTRUCTION DE  ' .. tostring(laboBpid) .. '  ARMEE ' .. tostring(idArmee) .. '  LaboReInit = ' .. repr(LaboReInit) )
					#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
				end

				self.idPerePremierLabo = builder.Sync.id  --# INDISPENSABLE POUR OnDestroy
				--ESSENTIAL FOR OnDestroy

				#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
				LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnStartBeingBuilt  :  TRANSFERT ID LABO  ' .. idUnite .. ' <type = ' .. type(idUnite) .. '>  ( PREMIERE CONSTRUCTION / RECONSTRUCTION ) !  builder.catBatimentsDejaContruits = ' .. repr(builder.catBatimentsDejaContruits) )
				#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			...
			elseif  EntityCategoryContains( catLabo, builder )  then
				...
				if  self:PasseAuNiveauTechSuivant( self, builder ) == true  then
					...
					if  zeUBC  and  zeUBC != nil  and  not zeUBC:IsDead()  then
						...
						#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
						LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnStartBeingBuilt  :  ID LABO UPGRADE = ' .. idUnite .. ' <type = ' .. type(idUnite) .. '>  zeUBC.catBatimentsDejaContruits = ' .. repr(zeUBC.catBatimentsDejaContruits) )
						#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
					end
				end
				...
				#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
				LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnStartBeingBuilt  :  TRANSFERT ID LABO ( UPGRADE ) !' )
				#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

			end  --# END IF  EntityCategoryContains
			
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnStartBeingBuilt  :   Father of the Lab = ' .. tostring(self.idPerePremierLabo) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	-- BUGFIX BY ETHERR --------------------------------------------------------------------------------------------------
		--disable ability to build extra labs when one already finished.
		--not perfect but solves issue 50%. With into to Faf function onStartBeingBuilt behaves differently so it is 
		-- impossible to set restriction in there without breaking stuff. 
		-- but it is still possible to build multiple labs using some window space between constructions.
		--I might make a script to prevent this  later.
    ...
    OnStopBeingBuilt = function( self, builder, layer )
		...
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnStopBeingBuilt  :  CONSTRUCTION DE LABO '.. tostring(idUnite) .. '  PAR  ' .. tostring(idUniteBuilder) .. '  SUR  ' .. tostring(layer) )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		...
		if  fractionComplete == 1  then  --# ASSURANCE QUE UPGRADE / RECONSTRUCTION EST TERMINÉ
			...
			if  EntityCategoryContains( catCmndr, builder )  then
				...
				if  indexLabo  and  indexLabo > 0  then
					...
					#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
					LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnStopBeingBuilt  :  LABO  RECONSTRUIT ID = ' .. tostring(self.Sync.id) .. ' ARMY ' .. tostring(idArmee) .. '  INDEX = ' .. tostring(indexLabo) .. '  LaboReInit AVANT MODIF = ' .. repr(LaboReInit) )
					#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
				...
				#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
				LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnStopBeingBuilt  :  VERIF  LABO ID = ' .. tostring(self.Sync.id) .. ' ARMY ' .. tostring(idArmee) .. '  LaboReInit = ' .. repr(LaboReInit) )
				#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			...
			--#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnStopBeingBuilt  :  CONTROLE AVANT MODIF  ListeSyncLabos = ' .. repr(ListeSyncLabos) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

			self:AjouterUniteDansListeSyncLabos()  --# TRANSFERT ID LAB0

			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnStopBeingBuilt  :  CONTROLE APRES MODIF  ListeSyncLabos = ' .. repr(ListeSyncLabos) )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    OnStartBuild = function( self, unitBeingBuilt, order )
		...
		if  unitBeingBuiltId == upgradesToUnitId  and  order == 'Upgrade'  then
			...
			if  EstUneRecherche( unitBeingBuilt ) == true  then
				...
				#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
				LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnStartBuild  :  LABO ACTION = RECHERCHE LANCEE !\n' )
				#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			end
		end
    end,
...
--[[
    ...
    OnStopBuild = function( self, unitBeingBuilt, order )
		...
		if  order  and  order == 'Upgrade'  then # SHUNTÉ PAR UpgradingState.OnStopBuild !
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnStopBuild  :  AMELIORATION  DE ' .. tostring(selfUnId) .. ' EN ' .. tostring(ubbId) .. ' TERMINEE !' )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			--# TRAITER LES RECHERCHES DU LABO
			--# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			if  EstUneRecherche( unitBeingBuilt ) == true  then  --# LE LABO TERMINE LA RECHERCHE !!!
				...
				#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
				LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnStopBuild  :  LABO ACTION = RECHERCHE TERMINÉE !\n' )
				#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			end
		end
    ...
    OnReclaimed = function( self, entity )
		...
		local idUnite = self:GetUnitId() or "UNITE INCONNUE"
		local idEntity = entity:GetUnitId() or "UNITE INCONNUE"
		LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnReclaimed  : UNITE RECYCLEE ' .. tostring(idUnite) .. '  PAR  ' .. tostring(idEntity) .. '\n' )
		#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        and  self.UnitBeingBuilt:GetFractionComplete() != 1  then
			...
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			local ubbId = self.UnitBeingBuilt:GetUnitId()
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnReclaimed  :  RECYCLAGE DU LABO ' .. tostring(idUnite) .. ' AVEC SA RECHERCHE EN COURS ' .. tostring(ubbId) .. ' !!!\n' )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        end
    ...
    OnKilled = function( self, instigator, type, overkillRatio )
        ...
        and  self.UnitBeingBuilt:GetFractionComplete() != 1  then
			...
			LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnKilled  :  LABO ' .. tostring(uniteId) .. '  TUE PAR  ' .. tostring(tueurId) .. '  AVEC SA RECHERCHE EN COURS ' .. tostring(ubbId) .. ' !!!\n' )
			#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        end
		...
		if  self.LaboKilled == true  or  self.LaboReclaimed == true  then
			...
			if  indexTypeUnite  and  indexTypeUnite > 0  then
				if  zeUBC != false  and  zeUBC != nil  and  not zeUBC:IsDead()  and  idArmee == zeUBC.Sync.army  then
					...
					#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
					LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnDestroy  :  VERIF  AVANT  uniteId = ' .. tostring(uniteId) .. '  indexTypeUnite = ' .. nomType[indexTypeUnite] .. '  self.idPerePremierLabo = ' .. tostring(self.idPerePremierLabo) .. '  zeUBC.LaboReInit = ' .. repr(zeUBC.LaboReInit) )
					#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
					...
					#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
					LOG( 'MANIMAL TRACEUR  /hook/lua/EW_DefaultUnits.lua  LSU  ->  OnDestroy  :  VERIF  APRES  uniteId = ' .. tostring(uniteId) .. '  indexTypeUnite = ' .. nomType[indexTypeUnite] .. '  self.idPerePremierLabo = ' .. tostring(self.idPerePremierLabo) .. '  zeUBC.LaboReInit = ' .. repr(zeUBC.LaboReInit) )
					#~~~~~ TRACEURS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
