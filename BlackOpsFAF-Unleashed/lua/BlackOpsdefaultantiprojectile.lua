...
SeraLambdaFieldRedirector = Class(Entity) {
    ...
    RedirectBeams = {#'/mods/BlackOpsFAF-Unleashed/effects/emitters/invisible_cannon_beam_01_emit.bp',
                   '/mods/BlackOpsFAF-Unleashed/effects/emitters/invisible_cannon_beam_02_emit.bp'},
...
TorpRedirectField = Class(Entity) {
    ...
    RedirectBeams = {#'/mods/BlackOpsFAF-Unleashed/effects/emitters/torp_beam_01_emit.bp',
                   '/mods/BlackOpsFAF-Unleashed/effects/emitters/Torp_beam_02_emit.bp'},
    EndPointEffects = {'/effects/emitters/particle_cannon_end_01_emit.bp',},
	#LambdaEffects = BlackOpsEffectTemplate.EXLambdaRedirector,
