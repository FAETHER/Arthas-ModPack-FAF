--[[#######################################################################
#  File     :  /units/Labos/RSB7205/RSB7205_script.lua
#  Author(s):  GPG Devs
...
RSB7205 = Class( SLandResearchLabUnit ) {
	SwitchAnims = true,
    ...
    OnCreate = function(self)
		...
		self.Rotator6 = CreateRotator(self, 'B06', 'y', nil, -25, 0, 0)
        self.Trash:Add(self.Rotator6)
		self.Rotator7 = CreateRotator(self, 'B07', 'y', nil, -25, 0, 0)
        self.Trash:Add(self.Rotator7)
		self.Rotator8 = CreateRotator(self, 'B08', 'y', nil, -25, 0, 0)
        self.Trash:Add(self.Rotator8)
		self.Rotator9 = CreateRotator(self, 'B09', 'y', nil, -25, 0, 0)
        self.Trash:Add(self.Rotator9)
		self.Rotator10 = CreateRotator(self, 'B10', 'y', nil, -25, 0, 0)
